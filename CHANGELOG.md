...
### Fixed
- Fix Carousel slide error when Carousel is updated

## [1.3.1-beta] - 2019-09-05

### Fixed
- Carousel slide error runs into an infinite Loader

## [1.3.0] - 2019-08-14

### Changed
- Upgrade Styleguide version to 9.x
