...
var transitionStyle = function transitionStyle(transitionTime) {
  return { transition: transitionTime + 'ms ease-in-out' };
};
    ...
    return React.createElement(
      ...
      function (state) {
        return React.createElement(
          'div',
          {
            style: _extends({}, transitionStyle(transitionTime), { height: height, overflow: 'hidden' }),
            className: 'relative' },
          React.createElement(
            'div',
          ...
          React.createElement(
            ...
            React.createElement('div', { style: transitionStyle(fadeOutTime),
